...
namespace ucle::util {
    ...
    class simple_shared_ptr {
        ...
        public:
            ...
            template <typename U>
            simple_shared_ptr(const simple_shared_ptr<U>& ptr) noexcept : pn_ { ptr.pn } { acquire_(static_cast<typename simple_shared_ptr<T>::element_type*>(ptr.px_)); }
            template <typename U>
        ...
        private:
            ...
            template <typename U>
            friend class basic_shared_ptr;
        
        template<typename U, typename V>
        friend bool operator==(const simple_shared_ptr<U>& l, const simple_shared_ptr<V>& r) noexcept { return l.get() == r.get(); }
        template<typename U, typename V>
        friend bool operator!=(const simple_shared_ptr<U>& l, const simple_shared_ptr<V>& r) noexcept { return l.get() != r.get(); }
    };
